...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-graduation-cap"></i> Brainbooster </a>
   

    <nav class="navbar">
        <a href="../login.php"class="fas fa-user-circle"><span style="padding-left: 4px; font-weight: 400">profile</span></a>
    ...
    <p class="credit">created by <span>mr.Uchit and mr.Nishan</span><a href="../adminlogin/adminlogin.php">admin</a>  | all rights reserved!
  </p>
